package com.cauergarcia.workshopmongodb.config;
...
import com.cauergarcia.workshopmongodb.dto.AuthorDTO;
import com.cauergarcia.workshopmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"),
				"Let's go on a trip", "I'm going to travel to São Paulo", new AuthorDTO(maria));
		
		Post post2 = new Post(null, sdf.parse("23/03/2018"),
				"Good morning", "I woke up happy today!", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Have a nice trip, mate!",
				sdf.parse("21/03/2018"), new AuthorDTO(maria));
		
		CommentDTO c2 = new CommentDTO("Enjoy!",
				sdf.parse("22/03/2018"), new AuthorDTO(bob));
		
		CommentDTO c3 = new CommentDTO("Have a nice day!",
